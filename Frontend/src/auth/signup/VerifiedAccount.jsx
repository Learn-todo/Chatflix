          ...
          {<div className={`${style._form_div} bg-background rounded`}>
            ...
            <div className={`${style._form_content} mx-auto my-3 px-4`}>
              <div className={`mb-5 text-center`}>
                <h3 className={`text-arrow mb-2 fs-3 lh-4`}>Account Created Successfully</h3>
                <p className={`text-text-color`}>
                  Your account has been successfully created. Click the button below to magically login.
                </p>
              </div>
