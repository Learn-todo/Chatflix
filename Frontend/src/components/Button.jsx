const Button = ({ type, size, text }) => {
  return (
    <button
      className={`${
        type === "primary" &&
        "bg-primary active:bg-primary-800 hover:shadow-lg hover:shadow-primary/40"
      } ${
        type === "secondary" &&
      ...
      } outline-1 outline-offset-1 outline-primary-900/40 transition ease-out duration-300 flex items-center justify-center text-white rounded-[5px]`}
    >
